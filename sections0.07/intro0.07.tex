...
\textbf{We cluster both \citetalias{Kinney96} templates and \citetalias{Hossein12} data, usign K-means clustering method and compare the results with the results from SOM clustering.}
