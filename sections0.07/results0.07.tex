...
\label{sec: result}
    ...
    \label{sec: 1D_somz}
        ...
        \label{sec: 1Dt}
            ...
            If the templates from \citetalias{Kinney96} had completely distinct \textbf{\textcolor{red}{spectral types}}, then a $1\times12$-sized SOM would be expected to show 12 different groups each containing a single template.
        ...
        \subsubsection{Classifying the Galaxy Sample}
         \label{sec: 1Dv}
            ...
            Since in this network galaxies were forced to be divided into a maximum of two groups, the strongest feature in a galaxy's \textbf{\textcolor{red}{spectrum}} predominantly decides to which group the galaxy belongs.
           ...
           As in Figs.~\ref{fig: 1by2V} and ~\ref{fig: 1by3V}, the upper panel of Fig.~\ref{fig: 1by22V} shows the number of galaxies (out of the 142) belonging to each neuron in the $1\times22$ SOM.
            ...
            If a cluster from the \citetalias{Hossein12} sample fills the same neuron as a \citetalias{Kinney96} template, we can conclude that the \textbf{\textcolor{red}{spectra}} of galaxies in the cluster are very similar to those of the template.
            Otherwise, we can conclude that the \textbf{\textcolor{red}{spectra of galaxies in the cluster are (dis)similar to two of the \citetalias{Kinney96} templates}}.
            ...
            We therefore conclude that there are no galaxies in the \citetalias{Hossein12} sample with \textbf{\textcolor{red}{spectral type}} similar to that of type B or E.
    ...
    \end{figure*}
        ...
        The upper panels in Fig.~\ref{fig: props_vs_props} show the same relations as \citetalias{Noll09} and \citetalias{Hossein12}, but with \textbf{more precision} than those two, in all three plots.
    ...
    The clusters were classified by finding the \citetalias{Kinney96} template spectrum with the most similarity to the median spectrum.
    ...
    This approach can be used to trace and recognize the outliers, \textbf{\textcolor{red}{which could include galaxy types that are not presented in the \citetalias{Kinney96} templates (e.g. dwarf galaxies, luminous infrared galaxies, or active galactic nuclei).}}
    ...
    Since we considered that \textbf{\textcolor{red}{spectra}} of all galaxies can be categorized using the \citetalias{Kinney96} templates, the galaxies were placed all over the map.
    Using this network to categorize any set of \textbf{\textcolor{red}{spectra}} forced the \textbf{\textcolor{red}{spectra}} to be either in the same neurons as the \citetalias{Kinney96} templates or in the neurons between them.
    In the map shown in the upper right panel in Fig.~\ref{fig: 12by12}, the \citetalias{Kinney96} templates are in a small region. This provides enough freedom for the \textbf{\textcolor{red}{spectra of galaxies}} to be placed everywhere in the map, even far away from the templates.
    ...
    \textbf{\citetalias{Hossein12} showed that when they mask emission lines (i.e., when we do not consider more details in the spectra) two types of galaxies, Sb and SB6 can be misclassified as one an other.
    ...
    In the lower right map in Fig.~\ref{fig: 12by12}, all galaxies are placed in the bottom part of the map and we can conclude that in the \citetalias{Hossein12} sample there are no outliers or \textbf{\textcolor{red}{spectra}} with very different from the \citetalias{Kinney96} templates.
