...
\label{sec: summary_SOMZ}
  ...
  This particular sample of high-redshift galaxies is well-described by the range of the \citetalias{Kinney96} templates although many of the spectra fall in between template classes.
    ...
    {\bf The freedom of having in-between types is one of the main differences between supervised and unsupervised artificial neural networks: the supervised training method used by   \citetalias{Hossein12}    could not classify 37 out of 142 spectra in galaxy sample as matching one of the same set of templates.}
