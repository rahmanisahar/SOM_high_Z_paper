...
\label{sec: result}
    ...
    \label{sec: 1D}
        ...
        \subsubsection{Classifying the galaxy sample}
         \label{sec: 1Dv}
           ...
           As in Figs.~\ref{fig: 1by2V} and ~\ref{fig: 1by3V}, the upper panel of Fig.~\ref{fig: 1by22V} shows the number of galaxies (out of the 142) belonging to each neuron in the $1\times22$ SOM.
            ...
            The empty neurons in a trained SOM show that there must be another type of template that is absent from the \citealias{K96} template spectra.
        ...
        In order to check whether our clustering in Sec.~\ref{sec: 1Dv}~is correct, in this section we examine the relations between median properties of the galaxies in each neuron.  %%%%%%%Sr220616:changed "conclusion" to clustering!
