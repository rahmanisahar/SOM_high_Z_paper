...
Following of T12 work, we chose these two sets of data to not only show the application of SOMs in clustering SEDs, but also to easily compare both supervised and unsupervised methods.
 ...
 \subsection{SED and Properties of the sample galaxies}
    ...
    The photometry data contains data in 10 - 13 filters with wavelength range of $\sim 0.4-24 \mu$m, in the observed frame. % PB160426: I assume these galaxies have spectroscopic redshifts, or were redshifts derived from photometry? from spectroscopic. 
