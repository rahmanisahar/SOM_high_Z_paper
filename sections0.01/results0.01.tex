...
\label{sec: result}
    ...
    %%% should I move this paragraph to method section?!
    ...
    \label{sec: 1D}
        ...
        \end{figure*} %PB160427: this figure looks really great! Very easy to understand.
           ...
           % For using SOM method, one should be careful about these small differences and consider that how much details do we need to pay attention to, to consider two groups are separate from each other.
           %%%% (I'm not sure if it is good to be here or not)
