...
(1) do galaxy spectra form a continuous distribution or can they be separated into discrete groups as represented by the \citetalias{Kinney96} templates? (2) if the distribution is continuous, how do galaxy properties vary along the spectral distribution?
}
