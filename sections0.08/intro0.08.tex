...
% HAVE NOT YET DONE THE FOLLOWING. MAY WANT TO INCLUDE COMMENTED SENTENCES.
We calculate the dispersion in properties between galaxies classified in the same groups in order to measure how well each classification method groups similar objects together.
}
