...
%Sahar: note that I changed the notation a little bit here, for both K-means and SOM. Where you had $n$ in the SOM description I changed it to $d$.
...
%Sahar: Please check that the last sentence is correct. Also please check that the K-means version you used was randomly picking the initial centroids - looks like Matlab can also do this in other ways.
