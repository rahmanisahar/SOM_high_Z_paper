...
As we show in the following sections, with data from real galaxies, we see that the number of dimensions are more than two and we never have two galaxies with exactly the same information. 
