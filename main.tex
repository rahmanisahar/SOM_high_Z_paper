...
\newline
2) with this method we not only can categorized the galaxies with more precision but also we could recognize the galaxies have similarity to two or more groups of galaxies.
\newline
