...
As a result we have a power tool to classify spectral glaxies based on their SEDs which also can  identify galaxies with a new shape of SEDs.
...
%%% what is the problem we are trying to solve in general! why do we want o classify thing in general, and what is wrong in exciting classification scheam
