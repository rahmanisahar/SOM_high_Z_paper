...
\begin{abstract}
The \textbf{\textcolor{red}{spectrum}} of a galaxy contains information about its physical properties.
Classifying \textbf{\textcolor{red}{spectra}} using templates helps elucidate the nature of a galaxy's energy sources.
However, available templates are limited, which can complicate \textbf{\textcolor{red}{spectral}} classification.
Most current classification methods classify \textbf{\textcolor{red}{spectra}} outside the range of templates \textbf{with low accuracy}, and will fail in special cases.
In this paper, we introduce a new method of classifying the \textbf{\textcolor{red}{spectra}}
...
The trained networks were used to classify the \textbf{\textcolor{red}{spectra}} of a sample of 142 galaxies with $0.5 < z < 1$.
Compared to previous attempts to classify this sample, the
self-organizing map approach was able to better classify the \textbf{\textcolor{red}{spectra}} which had
similarities with more than one template.
The \textbf{\textcolor{red}{median spectra}} and physical properties of the galaxies in each neuron of the self-organizing maps are consistent with other results on galaxy evolution.


\end{abstract}
\begin{keywords} 
 galaxies: high-redshift, 
 galaxies: \textbf{\textcolor{red}{spectra}}, 
...
\import{sections0.07/}{intro0.07.tex}
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
%DATA
...
\import{sections0.07/}{data0.07.tex}
...
\import{sections0.07/}{method0.07.tex}
...
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
\import{sections0.07/}{results0.07.tex}
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------
%Summery
...
A sample of 142 high-redshift galaxy \textbf{\textcolor{red}{spectra}} from \citetalias{Hossein12} was classified by the trained networks.
...
\citetalias{Hossein12} used a supervised training method to train networks with \citetalias{Kinney96} \textbf{\textcolor{red}{spectral}} templates and classify the same sample of 142 galaxy spectra;
...
%The classification based on SOM networks are not arbitrary, because there is an actual relation between each neurons}
...
\import{sections0.07/}{apps_0.07.tex}
\end{document}
