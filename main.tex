...
\begin{abstract}
The \textbf{\textcolor{red}{spectra}} of a galaxy contains information about its physical properties.
Classifying \textbf{\textcolor{red}{spectra}} using templates helps elucidate the nature of a galaxy's energy sources.
However, available templates are limited, which can complicate \textbf{\textcolor{red}{spectra}} classification.
...
Two-dimensional networks can be used to find the relations of the neurons and classifications in more detail.
...
The authors thank S. Lianou and A. Tammour, S.C. Gallagher and A. Sigut for their useful comments. 
