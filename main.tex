...
In this paper we introduce a new method of classifying high red shift galaxies, based on their SED.
We used an unsupervised self organizing map (SOM)method, to create a network based in SED models of galaxies and used sample of galaxies to test the networks. 
