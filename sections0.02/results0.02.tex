...
\label{sec: result}
    ...
    \label{sec: 1D}
       ...
       % These trends are another evidence that this method is working and can be used to categorize galaxies based on their SEDs or even their physical properties. %PB20160510: I would say something more like "the SED categories represent a continuum of physical properties". Of course the physical properties were derived from the SEDs, so maybe this isn't so surprising and you could mention that as well.
        %%%SR20160611: Sorry I am not sure that I understand this comment?
